...
#include "stdafx.h"
#include "MiaIconListBox.h"


/////////////////////////////////////////////////////////////////////////////
// MiaIconListBox

MiaIconListBox::MiaIconListBox()
{
...
void MiaIconListBox::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	...
	{
		rClient.left += 16;
		if ((int)lpDrawItemStruct->itemID == 2)
		{
			myColor = RGB(0,0,255);
			rText.left += 20;
		}
	...
	if (lpDrawItemStruct->itemState & ODS_SELECTED)
		...
		crText = pDC->SetTextColor(myColor/*::GetSysColor(COLOR_WINDOWTEXT)*/);
...
void MiaIconListBox::MeasureItem(LPMEASUREITEMSTRUCT lpMeasureItemStruct) 
{
	// TODO: Add your code to determine the size of specified item
	lpMeasureItemStruct->itemHeight = 16;
}

int MiaIconListBox::AddString(LPCTSTR lpszItem)
{
...
int MiaIconListBox::AddString(LPCTSTR lpszItem, int iImg)
{
	int iRet = CListBox::AddString(lpszItem);
	if (iRet >= 0)
...
int MiaIconListBox::InsertString(int iIndex, LPCTSTR lpszItem)
{
...
int MiaIconListBox::InsertString(int iIndex, LPCTSTR lpszItem, int iImg)
{
	int iRet = CListBox::InsertString(iIndex,lpszItem);
	if (iRet >= 0)
		SetItemData(iRet, iImg);
...
void MiaIconListBox::SetItemImage(int iIndex, int iImg)
{
